...
describe('Destructuring - Destructuring', () => {
    ...
    it('should fail "[...a, ] = c;"', () => {
        ...
        it('should parse nested array destructuring', () => {
        ...
        it('should parse "({x = 1, y = 2} = {});"', () => {
            expect(parseScript('({x = 1, y = 2} = {});', {
                ranges: true,
                raw: true,
                locations: true
            })).to.eql({
        ...
        it('should parse "[x, {y = 1}] = [0, {}];"', () => {
            expect(parseScript('[x, {y = 1}] = [0, {}];', {
                ranges: true,
                raw: true,
                locations: true
            })).to.eql({
        ...
        it('should parse "for ({a = 0} of [{}]) {}"', () => {
            expect(parseScript('for ({a = 0} of [{}]) {}', {
                ranges: true,
                raw: true,
                locations: true
            })).to.eql({
        ...
        it('should parse "var {get} = bar;"', () => {
            expect(parseScript('var {get} = bar;', {
                ranges: true,
                raw: true,
                locations: true
            })).to.eql({
        ...
        it('should parse "var bar = {get: "get"};"', () => {
            expect(parseScript('var bar = {get: "get"};', {
                ranges: true,
                raw: true,
                locations: true
            })).to.eql({
