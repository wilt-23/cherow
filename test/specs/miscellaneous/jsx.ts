...
describe('JSX', () => {
    ...
    it('should parse jsx spread children', () => {
      ...
      it.skip('should parse chinese tags', () => {
        expect(parseScript(`<日本語></日本語>`, {
            jsx: true,
            ranges: true,
        })).to.eql({
          "type": "Program",
      ...
      it('should parse "<A aa={aa.bb.cc} bb={bb.cc.dd}><div>{aa.b}</div></A>"', () => {
        expect(parseScript('<A aa={aa.bb.cc} bb={bb.cc.dd}><div>{aa.b}</div></A>', {
            jsx: true,
            ranges: true
        })).to.eql({
          "type": "Program",
