...
"sourceType": "script"
    ...
    it('should parse "({x = 0}, {y = 0}, {z = 0})=>0"', () => {
        expect(parseScript(`({x = 0}, {y = 0}, {z = 0})=>0`, {
            ranges: true,
            raw: true,
            locations: true
        })).to.eql({
    ...
    it('should parse cover rest concisebody functionbody', () => {
        expect(parseScript('var af = (...x) => { return x.length; };', {
            ranges: true,
            raw: true,
            locations: true
        })).to.eql({
